...
\newglossaryentry{technologiestack}{
	...
	description={Een set technologiën die samen een geheel bouwen, veel bedrijven werken bijvoorbeeld met de Microsoft Stack(Office, Azure, ...) en zijn hier ook aan gebonden. }
}


\printglossary[title=Lijst van figuren]
