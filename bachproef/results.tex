...
%% 	Beste Laurent,
%% 
%% 	Ik heb jouw toepassing op jouw computer lokaal een paar keer getest en had je beloofd eerstdaags schriftelijk mijn bedenkingen te bezorgen, dus bij deze. 
%% 
%% 	Pluspunten:
%% 	- Allereerst: mooie realisatie! De website ziet er mooi uit en is zoals je zei heel makkelijk in gebruik. Kudo's!
%% 	- 
%% 
%% 
%% 	Minpunten:
%% 	- Spelling: de spelling van de chatbot is soms volledig fout. Ik weet niet hoe dit komt maar ik zou dat toch eens bekijken. 
%% 	- 
%% 
%% \end{lstlisting}
